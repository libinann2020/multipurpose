                        ...
                        <div class="card-body">
                            <Form @submit="handleSubmit" v-slot:default="{ errors }">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea v-model="form.description" class="form-control" id="description" :class="{'is-invalid': errors.description}" rows="3"
...
const getAppointment = () => {
    ...
    .then((data) => {
        ...
        form.start_time = data.data.formatted_start_time;
        form.end_time = data.data.formatted_end_time;
